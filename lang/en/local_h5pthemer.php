...
$string['custom_css_cumulative'] = 'Cumulative';
$string['custom_css_desc'] = 'Add custom CSS rules that will be injected into all H5P contents. This field is strictly reserved for administrators for security reasons.';
...
$string['importpreset_error'] = 'Invalid preset file format.';
$string['invalid_presets_config'] = 'Invalid presets JSON configuration. Must be an array of objects with id, name, and colors.';
$string['invalid_theme_config'] = 'Invalid theme configuration. Please ensure you select a valid theme.';
...
$string['privacy:metadata'] = 'The H5P Themer plugin does not store any personal data.';
