...
$string['invalid_presets_config'] = 'Invalid presets configuration format or unsafe values.';
$string['invalid_theme_config'] = 'Invalid theme configuration format or unsafe values.';
